<div class="input-group mb-3">
  ...
  <textarea class="form-control" name="nombrecliente" placeholder="Ingrese datos del cliente" id="nombrecliente"></textarea>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1"><b>DUI</b></span>
  <input type="text" class="form-control" placeholder="########-#" name="dui" id="dui" pattern="[0-9]{8}-[0-9]{1}" title="Ingrese un número de DUI válido (########-#)" maxlength="10" required>
</div>
<div class="input-group mb-3">
...
<div class="input-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="nombre@correo.com" id="email" name="email">    
</div>
<div class="input-group mb-3">
...
<!-- Validar dui que solo sean numeros-->
<script>
